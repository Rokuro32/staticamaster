...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant = 'primary', size = 'md', isLoading, children, disabled, ...props }, ref) => {
    ...
    const variants = {
      ...
      danger:
        'bg-error-500 text-white hover:bg-error-600 focus:ring-error-500 active:bg-red-700',
      success:
        'bg-success-500 text-white hover:bg-success-600 focus:ring-success-500 active:bg-green-700',
    };
