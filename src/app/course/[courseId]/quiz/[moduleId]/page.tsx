...
import { getCourseById, getModuleById, COURSE_COLORS, type CourseId } from '@/types/course';
...
export default function QuizPage() {
  ...
  const module = course ? getModuleById(courseId, moduleId) : null;
  ...
  if (!course || !module) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-16 text-center">
        ...
        <p className="text-gray-600 mb-8">Le module demandé n'existe pas pour ce cours.</p>
        <Button onClick={() => router.push(`/course/${courseId}/modules`)}>
          Retour aux modules
        </Button>
      </div>
    );
        ...
        <Card variant="bordered">
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-600">
              Préparation des questions pour: {module.titleFr}
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <Card variant="bordered">
          <CardContent className="text-center py-12">
            ...
            <div className="flex justify-center gap-4">
              <Button variant="outline" onClick={() => router.push(`/course/${courseId}/modules`)}>
                Retour aux modules
              </Button>
